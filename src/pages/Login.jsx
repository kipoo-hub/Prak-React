...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background decoration — konsisten dengan dashboard */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">Masuk ke dashboard management system</p>
        </div>

        {/* Card Login */}
        <div className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 p-8 md:p-10">
          <h2 className="text-2xl font-black text-gray-900 mb-6">Masuk</h2>
