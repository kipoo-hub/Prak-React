...
export default function HitungGajiForm() {
    ...
    const totalGaji = Gaji - (Gaji * pajak); // Menghitung gaji bersih setelah pajak
    ...
    return (
		<div className="flex flex-col items-center justify-center m-5 p-5 bg-gray-100">
			<div className="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                {!gaji ? (
                    <div className="my-4 p-3 bg-red-100 border-red-500 text-red-700">
                        <p className="font-semibold">
                            Silahkan masukkan gaji pokok untuk menghitung THP.
                        </p>
                    </div>
                ) : (
